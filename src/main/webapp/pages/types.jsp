...
<script>
  function last(e) {
    ...
    else e.href = "${pageContext.request.contextPath}/category/list.do?id=${id}&pageNum=${pageNum-1}";
  }
  function next(e) {
  ...
  <div class="ui container">
    <div class="ui inverted secondary stackable menu">
      ...
      <!--<div class="right m-item item m-mobile-hide">-->
        ...
        <a href="${pageContext.request.contextPath}/category/list.do?id=0&pageNum=1" class="active m-item item m-mobile-hide"><i class="clone outline icon"></i>分类</a>
      <!--</div>-->
      <div class="right m-item item m-mobile-hide">
        <form name="search" action="${pageContext.request.contextPath}/blog/search.do?pageNum=1" method="post" target="_blank">
          <div class="ui icon transparent input m-margin-tb-tiny" style="color: white">
            ...
            <i onclick="return alert('暂未开放')" class="search link icon"></i>
          </div>
        </form>
      </div>
    </div>
      ...
      <div class="ui segment m-padded-tb-large m-opacity">
        <div class="ui container" align="center">
          ...
          <div class="ui labeled button m-margin-tb-tiny">
            <a href="${pageContext.request.contextPath}/category/list.do?id=${category.id}&pageNum=1" class="ui basic  button">${category.name}</a>
          </div>
          </c:forEach>
        </div>
      </div>
